            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative group flex justify-center lg:justify-start" data-aos="fade-right">
                        ...
                        <div className="absolute inset-0 bg-[image:var(--gradient-primary)] rounded-full blur-2xl opacity-20 group-hover:opacity-20 transition-opacity duration-500 scale-90"></div>

                        {/* Image Container */}
                        <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full border2 borderthemColor p-1.5 bg-white dark:bg-dark-200 shadow-2xl">
                            {/* Inner Gradient Border */}
                            <div className="absolute inset-0 rounded-full border-2 border-transparent bg-[image:var(--gradient-primary)] [mask:linear-gradient(#fff_0_0)_padding-box,linear-gradient(#fff_0_0)] opacity-100 group-hover:opacity-80 transition-opacity duration-500 z10"></div>

                            {/* Actual Image - Replace src with your import or URL */}
                            <img
                                src="./images/abdo.webp"
                                alt="Profile Picture"
                                className="w-full h-full object-cover rounded-full border-4 border-white dark:border-dark-200 transition-transform duration-500 group-hover:scale-[1.02] relative z-0"
                            />
                    ...
                    <div data-aos="fade-left">
                        ...
                        {/* Description */}
                        <p className="text-mainColor dark:text-gray-100 text-lg mb-6 leading-relaxed">
                        ...
                        {/* <p className="!text-secondary dark:!text-gray-400 mb-6 leading-relaxed">
                            🚀 <strong>What I Bring to the Table:</strong><br />
                            Full-Stack Web Development: Building modern, responsive web applications using React, Tailwind CSS, and
                            JavaScript (ES6+).<br />
                            Quality & Performance: Strong focus on SEO optimization, website speed, and delivering an excellent
                            user experience (UX).<br />
                            Engineering Mindset: High ability to analyze and solve technical problems, backed by solid experience in
                            Network Engineering (CCNA, Troubleshooting).
                        </p>

                        <p className="!text-secondary dark:!text-gray-400 mb-6 leading-relaxed">
                            • Server & Infrastructure Management (DevOps Mindset): Practical experience with virtual servers,
                            domain registration and configuration, mail server setup, and seamless integration with web applications.<br />
                            • Performance & Security: Improving website speed and protection through CDN integration (Cloudflare)
                            and optimized DNS configurations.<br />
                            • Analytics & Digital Marketing: Integrating Google Analytics to track traffic and user behavior,
                            supported by a digital marketing background that helps build websites aligned with business and marketing goals.
                        </p>

                        <p className="!text-secondary dark:!text-gray-400 mb-6 leading-relaxed">
                            🎓 <strong>Continuous Learning:</strong><br />
                            • Web Development Specialization – University of Michigan (Coursera).<br />
                            • Web Developer Nanodegree – Udacity (FWD).<br />
                            • McKinsey Forward Program – McKinsey & Company.<br />
                        ...
                        {/* <p className="text-mainColor dark:text-gray-300 text-lg mb-6 leading-relaxed">
                        ...
                        <p className="!text-secondary dark:!text-gray-400 mb-8 leading-relaxed">
